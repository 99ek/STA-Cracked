/* @preserve
 * kaos 1.9.4, a JS library for interactive maps. https://kaosjs.com
 * (c) 2010-2023 Vladimir Agafonkin, (c) 2010-2011 CloudMade
 */
!(function (t, e) {
    "object" == typeof exports && "undefined" != typeof module ? e(exports) : "function" == typeof define && define.amd ? define(["exports"], e) : e(((t = "undefined" != typeof globalThis ? globalThis : t || self).kaos = {}));
})(this, function (t) {
    "use strict";
    function l(t) {
    ...
    var D = 0;
    function h(t) {
        return "_kaos_id" in t || (t._kaos_id = ++D), t._kaos_id;
    }
    function j(t, e, i) {
        var n,
            o,
    ...
    function Z(t, e) {
        (t._kaos_pos = e), b.any3d ? be(t, e) : ((t.style.left = e.x + "px"), (t.style.top = e.y + "px"));
    }
    function Pe(t) {
        return t._kaos_pos || new p(0, 0);
    }
    function Le() {
    ...
    function Ie(t) {
        return S(t, "mousedown touchstart dblclick contextmenu", Ae), (t._kaos_disable_click = !0), this;
    }
    function O(t) {
    ...
    var mt = {
        ...
        A = it.extend({
                    ...
                    (t = m(t).round()).x || t.y
                        ? (!0 === e.animate || this.getSize().contains(t)
                              ? (this._panAnim || ((this._panAnim = new Fe()), this._panAnim.on({ step: this._onPanTransitionStep, end: this._onPanTransitionEnd }, this)),
                                ...
                                !1 !== e.animate
                                    ? (M(this._mapPane, "kaos-pan-anim"), (i = this._getMapPanePos().subtract(t).round()), this._panAnim.run(this._mapPane, i, e.duration || 0.25, e.easeLinearity))
            ...
            remove: function () {
                if ((this._initEvents(!0), this.options.maxBounds && this.off("moveend", this._panInsideMaxBounds), this._containerId !== this._container._kaos_id)) throw new Error("Map container is being reused by another instance");
                try {
                    delete this._container._kaos_id, delete this._containerId;
                } catch (t) {
                    (this._container._kaos_id = void 0), (this._containerId = void 0);
                }
            ...
            createPane: function (t, e) {
                e = P("div", "kaos-pane" + (t ? " kaos-" + t.replace("Pane", "") + "-pane" : ""), e || this._mapPane);
            ...
            _initContainer: function (t) {
                ...
                if (t._kaos_id) throw new Error("Map container is already initialized.");
                ...
                var t = this._container,
                    e =
                        ...
                        M(
                            ...
                            "kaos-container" +
                                (b.touch ? " kaos-touch" : "") +
                                (b.retina ? " kaos-retina" : "") +
                                (b.ielt9 ? " kaos-oldie" : "") +
                                (b.safari ? " kaos-safari" : "") +
                                (this._fadeAnimated ? " kaos-fade-anim" : "")
                        ),
                        pe(t, "position"));
            ...
            _initPanes: function () {
                ...
                (this._paneRenderers = {}),
                    ...
                    this.options.markerZoomAnimation || (M(t.markerPane, "kaos-zoom-hide"), M(t.shadowPane, "kaos-zoom-hide"));
            },
            ...
            _isClickDisabled: function (t) {
                for (; t && t !== this._container; ) {
                    if (t._kaos_disable_click) return !0;
                    t = t.parentNode;
                }
            },
            _handleDOMEvent: function (t) {
                ...
                !this._loaded || i._kaos_disable_events || ("click" === t.type && this._isClickDisabled(i)) || ("mousedown" === (e = t.type) && Me(i), this._fireDOMEvent(t, e));
            },
            ...
            _onPanTransitionEnd: function () {
                z(this._mapPane, "kaos-pan-anim"), this.fire("moveend");
            },
            ...
            _createAnimProxy: function () {
                var t = (this._proxy = P("div", "kaos-proxy kaos-zoom-animated"));
            ...
            _nothingToAnimate: function () {
                return !this._container.getElementsByClassName("kaos-zoom-animated").length;
            },
            ...
            _animateZoom: function (t, e, i, n) {
                this._mapPane &&
                    (i && ((this._animatingZoom = !0), (this._animateToCenter = t), (this._animateToZoom = e), M(this._mapPane, "kaos-zoom-anim")),
            ...
            _onZoomTransitionEnd: function () {
                this._animatingZoom &&
                    (this._mapPane && z(this._mapPane, "kaos-zoom-anim"),
    ...
    var B = et.extend({
            ...
            addTo: function (t) {
                ...
                return M(e, "kaos-control"), -1 !== i.indexOf("bottom") ? t.insertBefore(e, t.firstChild) : t.appendChild(e), this._map.on("unload", this.remove, this), this;
            },
            remove: function () {
        ...
        Ve =
            ...
            B.extend({
                ...
                expand: function () {
                    M(this._container, "kaos-control-layers-expanded"), (this._section.style.height = null);
                    var t = this._map.getSize().y - (this._container.offsetTop + 50);
                    return (
                        t < this._section.clientHeight ? (M(this._section, "kaos-control-layers-scrollbar"), (this._section.style.height = t + "px")) : z(this._section, "kaos-control-layers-scrollbar"),
                        this._checkDisabledLayers(),
                        this
                    );
                },
                collapse: function () {
                    return z(this._container, "kaos-control-layers-expanded"), this;
                },
                _initLayout: function () {
                    var t = "kaos-control-layers",
                ...
                _createRadioElement: function (t, e) {
                    (t = '<input type="radio" class="kaos-control-layers-selector" name="' + t + '"' + (e ? ' checked="checked"' : "") + "/>"), (e = document.createElement("div"));
                ...
                _addItem: function (t) {
                    var e,
                        ...
                        n =
                            (t.overlay
                                ? (((e = document.createElement("input")).type = "checkbox"), (e.className = "kaos-control-layers-selector"), (e.defaultChecked = n))
                                : (e = this._createRadioElement("kaos-base-layers_" + h(this), n)),
        ...
        Ke = B.extend({
            options: {
                ...
                prefix:
                    '<a href="https://kaosjs.com" title="A JavaScript library for interactive maps">' +
                    (b.inlineSvg
                        ? '<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" class="kaos-attribution-flag"><path fill="#4C7BE1" d="M0 0h12v4H0z"/><path fill="#FFD500" d="M0 4h12v3H0z"/><path fill="#E0BC00" d="M0 7h12v1H0z"/></svg> '
                        : "") +
                    "kaos</a>",
            },
            initialize: function (t) {
            ...
            onAdd: function (t) {
                for (var e in (((t.attributionControl = this)._container = P("div", "kaos-control-attribution")), Ie(this._container), t._layers)) t._layers[e].getAttribution && this.addAttribution(t._layers[e].getAttribution());
        ...
        Xe = it.extend({
            ...
            _onDown: function (t) {
                ...
                this._enabled &&
                    ((this._moved = !1),
                    ve(this._element, "kaos-zoom-anim") ||
                    ...
                    (t.touches && 1 < t.touches.length
                        ...
                        : (!(e = new p((e = t.touches && 1 === t.touches.length ? t.touches[0] : t).clientX, e.clientY)._subtract(this._startPoint)).x && !e.y) ||
                          ...
                          this._moved ||
                              ...
                              M(this._lastTarget, "kaos-drag-target")),
            ...
            finishDrag: function (t) {
                z(document.body, "kaos-dragging"),
                    this._lastTarget && (z(this._lastTarget, "kaos-drag-target"), (this._lastTarget = null)),
    ...
    var vt = {
        ...
        di = et.extend({
            ...
            _setIconStyles: function (t, e) {
                ...
                (t.className = "kaos-marker-" + e + " " + (i.className || "")), o && ((t.style.marginLeft = -o.x + "px"), (t.style.marginTop = -o.y + "px")), n && ((t.style.width = n.x + "px"), (t.style.height = n.y + "px"));
            },
    ...
    var _i = di.extend({
            ...
            _detectIconPath: function () {
                var t = P("div", "kaos-default-icon-path", document.body),
                    e = pe(t, "background-image") || pe(t, "backgroundImage");
                return document.body.removeChild(t), (e = this._stripUrl(e)) ? e : (t = document.querySelector('link[href$="kaos.css"]')) ? t.href.substring(0, t.href.length - "kaos.css".length - 1) : "";
            },
        }),
        pi = n.extend({
            initialize: function (t) {
            ...
            addHooks: function () {
                ...
                this._draggable || (this._draggable = new Xe(t, t, !0)),
                    ...
                    M(t, "kaos-marker-draggable");
            },
            removeHooks: function () {
                this._draggable.off({ dragstart: this._onDragStart, predrag: this._onPreDrag, drag: this._onDrag, dragend: this._onDragEnd }, this).disable(), this._marker._icon && z(this._marker._icon, "kaos-marker-draggable");
            },
            moved: function () {
        ...
        mi = o.extend({
            ...
            _initIcon: function () {
                var t = this.options,
                    e = "kaos-zoom-" + (this._zoomAnimated ? "animated" : "hide"),
        ...
        Ei = o.extend({
            ...
            onAdd: function () {
                this._image || (this._initImage(), this.options.opacity < 1 && this._updateOpacity()),
                    this.options.interactive && (M(this._image, "kaos-interactive"), this.addInteractiveTarget(this._image)),
            ...
            _initImage: function () {
                ...
                M(e, "kaos-image-layer"),
                    this._zoomAnimated && M(e, "kaos-zoom-animated"),
    ...
    var Oi = Ei.extend({
        _initImage: function () {
            ...
            M(t, "kaos-image-layer"), this._zoomAnimated && M(t, "kaos-zoom-animated"), this.options.className && M(t, this.options.className), (t.onselectstart = u), (t.onmousemove = u);
        },
    });
    var Ai = o.extend({
            ...
            onAdd: function (t) {
                (this._zoomAnimated = t._zoomAnimated),
                    ...
                    this.bringToFront(),
                    this.options.interactive && (M(this._container, "kaos-interactive"), this.addInteractiveTarget(this._container));
            },
            onRemove: function (t) {
                t._fadeAnimated ? (C(this._container, 0), (this._removeTimeout = setTimeout(a(T, void 0, this._container), 200))) : T(this._container),
                    this.options.interactive && (z(this._container, "kaos-interactive"), this.removeInteractiveTarget(this._container));
            },
            getLatLng: function () {
                return this._latlng;
            },
        ...
        Bi =
            ...
            Ai.extend({
                ...
                _initLayout: function () {
                    var t = "kaos-popup",
                        e = (this._container = P("div", t + " " + (this.options.className || "") + " kaos-zoom-animated")),
        ...
        Ii =
            ...
            Ai.extend({
                ...
                _initLayout: function () {
                    var t = "kaos-tooltip " + (this.options.className || "") + " kaos-zoom-" + (this._zoomAnimated ? "animated" : "hide");
                    (this._contentNode = this._container = P("div", t)), this._container.setAttribute("role", "tooltip"), this._container.setAttribute("id", "kaos-tooltip-" + h(this));
                },
                _updateLayout: function () {},
                _adjustPan: function () {},
                _setPosition: function (t) {
                    ...
                    (t = t.subtract(m(e, i, !0)).add(h).add(l)), z(n, "kaos-tooltip-right"), z(n, "kaos-tooltip-left"), z(n, "kaos-tooltip-top"), z(n, "kaos-tooltip-bottom"), M(n, "kaos-tooltip-" + s), Z(n, t);
                },
                _updatePosition: function () {
        ...
        Ri =
            ...
            di.extend({
                options: { iconSize: [12, 12], html: !1, bgPos: null, className: "kaos-div-icon" },
                createIcon: function (t) {
    ...
    var Ni = o.extend({
        ...
        _initContainer: function () {
            this._container || ((this._container = P("div", "kaos-layer " + (this.options.className || ""))), this._updateZIndex(), this.options.opacity < 1 && this._updateOpacity(), this.getPane().appendChild(this._container));
        },
        _updateLevels: function () {
            ...
            if (void 0 !== t) {
                ...
                return (
                    n ||
                        (((n = this._levels[t] = {}).el = P("div", "kaos-tile-container kaos-zoom-animated", this._container)),
                        (n.el.style.zIndex = e),
        ...
        _tileReady: function (t, e, i) {
            ...
            (i = this._tiles[n]) &&
                ...
                e || (M(i.el, "kaos-tile-loaded"), this.fire("tileload", { tile: i.el, coords: t })),
    ...
    var Wi = o.extend({
            ...
            onAdd: function () {
                this._container || (this._initContainer(), M(this._container, "kaos-zoom-animated")), this.getPane().appendChild(this._container), this._update(), this.on("update", this._updatePaths, this);
            },
            onRemove: function () {
        ...
        Fi = Wi.extend({
            ...
            _handleMouseOut: function (t) {
                ...
                e && (z(this._container, "kaos-interactive"), this._fireEvent([e], t, "mouseout"), (this._hoveredLayer = null), (this._mouseHoverThrottled = !1));
            },
            _handleMouseHover: function (t, e) {
                if (!this._mouseHoverThrottled) {
                    for (var i, n, o = this._drawFirst; o; o = o.next) (i = o.layer).options.interactive && i._containsPoint(e) && (n = i);
                    n !== this._hoveredLayer && (this._handleMouseOut(t), n && (M(this._container, "kaos-interactive"), this._fireEvent([n], t, "mouseover"), (this._hoveredLayer = n))),
    ...
    var Vi = (function () {
        ...
        zt = {
            _initContainer: function () {
                this._container = P("div", "kaos-vml-container");
            },
            _update: function () {
            ...
            _initPath: function (t) {
                ...
                M(e, "kaos-vml-shape " + (this.options.className || "")), (e.coordsize = "1 1"), (t._path = Vi("path")), e.appendChild(t._path), this._updateStyle(t), (this._layers[h(t)] = t);
            },
            _addPath: function (t) {
                var e = t._container;
        ...
        Gi = Wi.extend({
            ...
            _initPath: function (t) {
                ...
                t.options.className && M(e, t.options.className), t.options.interactive && M(e, "kaos-interactive"), this._updateStyle(t), (this._layers[h(t)] = t);
            },
            _addPath: function (t) {
    ...
    var _t = n.extend({
            ...
            _onMouseMove: function (t) {
                this._moved || ((this._moved = !0), (this._box = P("div", "kaos-zoom-box", this._container)), M(this._container, "kaos-crosshair"), this._map.fire("boxzoomstart")),
            ...
            _finish: function () {
                this._moved && (T(this._box), z(this._container, "kaos-crosshair")), ae(), Te(), k(document, { contextmenu: Re, mousemove: this._onMouseMove, mouseup: this._onMouseUp, keydown: this._onKeyDown }, this);
            },
            ...
            n.extend({
                addHooks: function () {
                    ...
                    this._draggable ||
                        ...
                        M(this._map._container, "kaos-grab kaos-touch-drag"),
                        this._draggable.enable(),
                        (this._positions = []),
                        (this._times = []);
                },
                removeHooks: function () {
                    z(this._map._container, "kaos-grab"), z(this._map._container, "kaos-touch-drag"), this._draggable.disable();
                },
                moved: function () {
                    return this._draggable && this._draggable._moved;
                },
        ...
        Ot =
            ...
            n.extend({
                addHooks: function () {
                    M(this._map._container, "kaos-touch-zoom"), S(this._map._container, "touchstart", this._onTouchStart, this);
                },
                removeHooks: function () {
                    z(this._map._container, "kaos-touch-zoom"), k(this._map._container, "touchstart", this._onTouchStart, this);
                },
